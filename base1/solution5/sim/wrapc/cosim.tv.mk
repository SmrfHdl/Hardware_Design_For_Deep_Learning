...
$(ObjDir)/TestUtils.cpp_pre.cpp.tb.o : TestUtils.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling TestUtils.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/core_base.cpp_pre.cpp.tb.o : core_base.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling core_base.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
