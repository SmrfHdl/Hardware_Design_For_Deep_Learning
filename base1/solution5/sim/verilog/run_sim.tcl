...
if {[file isfile processImage.autotvin.dat]} {
	file delete -force processImage.autotvin.dat
}

if {[file isfile processImage.autotvout.dat]} {
	file delete -force processImage.autotvout.dat
}
