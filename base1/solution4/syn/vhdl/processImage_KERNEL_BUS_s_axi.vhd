...
entity processImage_KERNEL_BUS_s_axi is
generic (
...
end entity processImage_KERNEL_BUS_s_axi;
...
architecture behave of processImage_KERNEL_BUS_s_axi is
    ...
    signal int_kernel_0        : UNSIGNED(7 downto 0) := (others => '0');
    signal int_kernel_1        : UNSIGNED(7 downto 0) := (others => '0');
    signal int_kernel_2        : UNSIGNED(7 downto 0) := (others => '0');
    signal int_kernel_3        : UNSIGNED(7 downto 0) := (others => '0');
    signal int_kernel_4        : UNSIGNED(7 downto 0) := (others => '0');
    signal int_kernel_5        : UNSIGNED(7 downto 0) := (others => '0');
    signal int_kernel_6        : UNSIGNED(7 downto 0) := (others => '0');
    signal int_kernel_7        : UNSIGNED(7 downto 0) := (others => '0');
    signal int_kernel_8        : UNSIGNED(7 downto 0) := (others => '0');
