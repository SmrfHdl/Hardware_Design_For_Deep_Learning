...
module AESL_autofifo_outStream_V_dest_V (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.processImage.autotvin_outStream_V_dest_V.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.processImage.autotvout_outStream_V_dest_V.dat";
