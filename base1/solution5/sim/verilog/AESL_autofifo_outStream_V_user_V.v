...
module AESL_autofifo_outStream_V_user_V (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.processImage.autotvin_outStream_V_user_V.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.processImage.autotvout_outStream_V_user_V.dat";

//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 2;
parameter ADDR_WIDTH = 32'd 19;
parameter DEPTH = 32'd 262144;
